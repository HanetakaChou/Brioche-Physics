...
extern "C" void brx_physics_destory_rigid_body(brx_physics_context *physics_context, brx_physics_world *physics_world, brx_physics_rigid_body *physics_rigid_body);
...
extern "C" void brx_physics_destory_constraint(brx_physics_context *physics_context, brx_physics_world *physics_world, brx_physics_constraint *physics_constraint);
